...
HOSTS = {
    ...
    "workbuddy": {
        ...
        "description_zh": "强制联网更新·每次ASK人机交互·猫娘口癖与记忆——代码库优先的猫娘工程搭档。",
        "description_en": "A catgirl engineering partner with mandatory web research, HITL ASK gates, and living feline voice and memory.",
        "category": "engineering",
        "author": "avabbbb",
    },
    "teleagent": {
        "name_cn": "福福猫娘工程搭档",
        "description_cn": "强制联网更新·每次ASK人机交互·猫娘口癖与记忆——先读代码库再开口，默认多轮联网核实，每个决策点都问你，喵着把活干完的猫娘工程搭档。",
        "description_zh": "强制联网更新·每次ASK人机交互·猫娘口癖与记忆——代码库优先的猫娘工程搭档。",
        "description_en": "A catgirl engineering partner with mandatory web research, HITL ASK gates, and living feline voice and memory.",
        "category": "engineering",
        "author": "avabbbb",
